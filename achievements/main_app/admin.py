...
class CourseAdmin(admin.ModelAdmin):
    ...
    search_fields = ['name', 'chapter', 'location', 'subject']
...
class SeminarAdmin(admin.ModelAdmin):
    ...
    list_filter = ('location', 'subject')
    search_fields = ['name', 'location', 'subject']
...
class OlympiadAdmin(admin.ModelAdmin):
    ...
    search_fields = ['name', 'location', 'stage']
...
class CourseParticipationAdmin(admin.ModelAdmin):
    ...
    search_fields = ['student__first_name', 'student__middle_name', 'student__last_name', 'student__username', 'started', 'finished', 'course__name']
...
class SeminarParticipationAdmin(admin.ModelAdmin):
    ...
    search_fields = ['student__first_name', 'student__middle_name', 'student__last_name', 'student__username', 'started', 'finished', 'seminar__name']
...
class ProjectParticipationAdmin(admin.ModelAdmin):
    ...
    search_fields = ['student__first_name', 'student__middle_name', 'student__last_name', 'student__username', 'started', 'finished', 'project__name']
...
class OlympiadParticipationAdmin(admin.ModelAdmin):
    ...
    search_fields = ['student__first_name', 'student__middle_name', 'student__last_name', 'student__username', 'started', 'finished', 'olympiad__name']
